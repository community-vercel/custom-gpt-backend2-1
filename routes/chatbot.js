...
router.get('/:flowId/:userId', async (req, res) => {
  ...
  try {
    ...
    res.set('Content-Security-Policy', `
      default-src 'self';
      script-src 'self' http://localhost:5000 https://custom-gpt-backend-six.vercel.app;
      style-src 'self' 'unsafe-inline' https://fonts.googleapis.com;
      font-src https://fonts.gstatic.com;
      img-src 'self' data: https://*;
      frame-ancestors *;
      connect-src 'self' http://localhost:5000 https://custom-gpt-backend-six.vercel.app
    `);
